...
function Ticket({winning, title, ticketCost, countdown, totalTickets }) {
  return (
    <div className="bg-cardBg rounded-lg relative w-full max-w-[18rem]">
      ...
      <div className="absolute top-[55%] left-1/2 transform -translate-x-1/2  bg-gradient-to-r from-gradientBottom to-gradientTop hover:bg-gradient-to-l px-4 py-3 rounded-full w-fit cursor-pointer">
        <span className="text-white text-center block font-lato text-base font-semibold shadow-sm">Get<br/>Ticket</span>
      </div>
